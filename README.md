...
- **[Report Composer POC — Spring Batch + Kafka + K8s](https://github.com/wallaceespindola/report-composer-poc)** - Distributed report composer generating one report per account, business date, report type and tenant, using **Spring Batch Remote Partitioning** over **Apache Kafka** on **Kubernetes** with autoscaling.
